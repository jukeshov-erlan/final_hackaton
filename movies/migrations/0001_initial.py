    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(blank=True, default=datetime.datetime.now, null=True, verbose_name='Премьера')),
                ('budget', models.PositiveIntegerField(help_text='указать сумму в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(help_text='указать сумму в долларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveIntegerField(help_text='указать сумму в долларах', verbose_name='Сборы в мире')),
